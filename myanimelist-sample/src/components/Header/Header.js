            ...
            <header className="p-2 bg-dark mb-2">
                <nav className="navbar navbar-expand-lg ">
                    <div className="container-fluid">
                        <NavLink className="navbar-brand header-logo text-white mt-2" to="/home">My Anime List</NavLink>
                            ...
                            <div className="collapse navbar-collapse " id="navbarSupportedContent">
                                <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                                    <li className="nav-item">
                                        <NavLink to='/anime' className="nav-link text-white" aria-current="page" href="/">Anime</NavLink>
                                    </li>
                                    <li className="nav-item">
